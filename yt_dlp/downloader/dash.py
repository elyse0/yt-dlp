...
from ..timeline import Playback, Timeline
from ..compat import compat_etree_fromstring
from . import get_suitable_downloader
from .fragment import FragmentFD
from ..utils import urljoin, parse_duration, parse_codecs, mimetype2ext, try_call, int_or_none, float_or_none, try_get, \
    ExtractorError, base_url, prepend_extension


class DashManifest:

    @staticmethod
    def get_formats_and_subtitles(mpd_doc, mpd_id=None, mpd_base_url='', mpd_url=None, dynamic_mpd=True):
        """
