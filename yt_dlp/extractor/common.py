...
from ..downloader.dash import MpdManifest
...
class InfoExtractor:
    ...
    def _parse_mpd_formats_and_subtitles(self, mpd_doc, mpd_id=None, mpd_base_url='', mpd_url=None):
        return MpdManifest.parse_formats_and_subtitles(
            mpd_doc, mpd_id, mpd_base_url, mpd_url, self.get_param('dynamic_mpd', True))
